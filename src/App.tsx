    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="max-w-4xl mb-16">
          ...
          <p className="text-xl text-gray-600">
            Practical SEO strategies and insights you can implement today. No
            fluff, just results-driven advice.
          </p>
        </div>
...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 max-w-6xl relative">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              <span className="text-blue-400 font-semibold mb-6 block">
                RANK N CONVERT
              </span>
              <h1 className="text-6xl font-bold text-white mb-8 leading-tight italic">
                <span className="text-white">
                  3+ Years. 30+ Niches. $800k In Revenue From SEO Alone.
                </span>
              </h1>
              <p className="text-xl text-blue-100 mb-12">
                With <span className="font-bold">3+ years</span> of hands-on
                experience across <span className="font-bold">50+ brands</span>,
                I build SEO systems that don't just rank - they grow revenue.
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
              Collaborating with innovative brands to drive exceptional growth
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 relative z-10">
              {[
                {
                  name: "iToolab AnyGo",
                  logo: "https://i.ibb.co/yJWHpXP/1.jpg",
                },
                { name: "Fones GO", logo: "https://i.ibb.co/kgzgfB4W/2.png" },
                { name: "Moc Pogo", logo: "https://i.ibb.co/QLHYCt6/3.jpg" },
                {
                  name: "Travel Triangle",
                  logo: "https://i.ibb.co/MDsKBJ6s/4.png",
                },
                {
                  name: "Security Base Group",
                  logo: "https://i.ibb.co/TDCFN9hh/5.jpg",
                },
                { name: "Qyubic", logo: "https://i.ibb.co/Kc1vL4bC/6.png" },
                {
                  name: "Thrive Together",
                  logo: "https://i.ibb.co/4ZBpGk20/7.jpg",
                },
                {
                  name: "Pepper Content",
                  logo: "https://i.ibb.co/4ZkPtWKL/10.jpg",
                },
              ].map((brand, index) => (
                <div
                  key={index}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-gray-600 mb-12">
              With 3+ years of hands-on experience across 50+ brands, I build
              SEO systems that don't just rank - they grow revenue. Every move I
              make is rooted in data, driven by strategy, and aligned with real
              business goals.
            </p>
            <button
              onClick={() => {
      ...
      <section
        id="stats-section"
        className="py-24 bg-blue-900 text-white overflow-hidden"
      >
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            <span className="text-blue-400 font-semibold mb-6 block">
          ...
          <div className="flex flex-nowrap overflow-x-auto md:overflow-x-visible gap-8 pb-4 md:pb-0">
            {[
              ...
              >
                ...
                <div className="text-blue-200 text-lg whitespace-nowrap">
                  {stat.label}
                </div>
              </div>
            ))}
        ...
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A systematic approach that consistently delivers results across
              ...
              {[
                {
                  ...
                  description:
                    "First, I uncover what's broken and what's blocking growth.",
                  icon: <Search className="w-6 h-6" />,
                },
                {
                  step: "Step 2: Content Optimization",
                  description:
                    "Then comes the clean-up—tuning your content for both users and search engines.",
                  icon: <FileCheck className="w-6 h-6" />,
                },
                {
                  step: "Step 3: Competitor Analysis",
                  description:
                    "Now it's time to study what's working for others—and build something smarter.",
                  icon: <Target className="w-6 h-6" />,
                },
                {
                  step: "Step 4: User Persona Creation",
                  description:
                    "With that, I craft detailed user personas to steer every SEO move.",
                  icon: <MessageSquare className="w-6 h-6" />,
                },
                {
                  step: "Step 5: Keyword Research",
                  description:
                    "Here, I dig into real search behavior and map keywords that actually bring results.",
                  icon: <Search className="w-6 h-6" />,
                },
                {
                  step: "Step 6: Build a Quarterly Calendar",
                  description:
                    "Next, I turn all that insight into a clear 90-day content roadmap.",
                  icon: <Settings className="w-6 h-6" />,
                },
                {
                  step: "Step 7: Content Production",
                  description:
                    "Finally, I put strategy into motion-creating content that ranks, converts, and compounds over time.",
                  icon: <FileCheck className="w-6 h-6" />,
                },
              ].map((item, index) => (
                <div key={index} className="relative flex items-center">
                  {/* Timeline Node */}
                  <div
                    className={`absolute left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full border-4 border-blue-200 ${
                  ...
                  >
                    <div
                      className={`bg-white p-8 rounded-xl shadow-lg transform transition-all duration-500 hover:scale-105 ${
                        index % 2 === 0
                          ? "hover:-translate-x-2"
                          : "hover:translate-x-2"
                      }`}
      ...
      <section className="py-24 bg-gray-900">
        <div className="container mx-auto px-6 max-w-6xl text-center">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto">
            Get a free, comprehensive SEO audit worth $1,500. I'll analyze your
            site, compare it against competitors, and show you exactly how to
            outrank them.
          </p>
          <Link to="/contact">
