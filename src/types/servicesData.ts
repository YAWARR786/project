export const servicesData = {
    'technical-seo-audit': {
      ...
      benefits: [
        ...
        'Improve site architecture for better indexing',
      ...
      process: [
        ...
        {
          title: 'Comprehensive Crawl',
          description: 'Deep crawl of up to 10,000 pages to identify issues',
          icon: '🕷️'
        },
        {
          title: 'Performance Analysis',
          description: 'Evaluate loading speed and user experience metrics',
          icon: '⚡'
        },
        {
          title: 'Reporting',
        ...
        },
        {
          ...
          description: 'Guidance through the fixing process',
          icon: '🛠️'
        }
      ],
      faqs: [
      ...
      caseStudy: {
        ...
        metrics: [
          ...
          '75% improvement in crawl efficiency'
        ]
      }
    },
    'keyword-strategy': {
    ...
    'content-strategy' :{
        ...
        benefits: [
          ...
          'Search intent mapping for all content',
        ...
        process: [
          {
            ...
            description: 'Develop detailed buyer personas and pain points',
            icon: '👥'
          },
          {
            title: 'Content Audit',
            description: 'Evaluate existing content performance and gaps',
            icon: '📑'
          },
          {
            title: 'Intent Mapping',
            description: 'Classify content by search intent (informational, commercial, etc.)',
            icon: '🧭'
          },
          {
            title: 'Blueprint Creation',
            description: 'Develop content clusters and topic architecture',
            icon: '🏗️'
          },
          {
            title: 'Measurement Plan',
            description: 'Define KPIs and tracking methodology',
            icon: '📏'
          }
        ],
        faqs: [
        ...
        caseStudy: {
          title: 'Healthcare Provider Dominates Local Market',
          description: 'Strategic content pillars helped this client own 78% of top positions for treatment-related queries in their region.',
          metrics: [
            '220% more appointment requests',
            '65% increase in content shares',
      ...
      'seo-blogs':{
        ...
        process: [
          {
            ...
            description: 'Research trending topics and evergreen opportunities',
            icon: '💡'
          },
          {
            title: 'Keyword Optimization',
            description: 'Select primary and secondary keywords for each post',
            icon: '🔑'
          },
          {
            title: 'Content Creation',
            description: 'Writing by subject matter experts with SEO best practices',
            icon: '✍️'
          },
          {
            title: 'Editorial Review',
            description: 'SEO and editorial quality checks',
            icon: '✅'
          },
          {
            title: 'Performance Tracking',
            description: 'Monitor rankings, traffic, and engagement',
            icon: '📊'
          }
        ],
        faqs: [
          {
            question: 'How long does it take to see results from blog content?',
            answer: 'Most posts gain traction in 3-6 months, though some competitive terms may take 9-12 months to rank.'
          },
          {
        ...
        caseStudy: {
          title: 'Fintech Startup Builds Authority Through Content',
          description: 'Consistent, high-quality blogging established them as thought leaders and drove 85% of their organic leads.',
          metrics: [
            '17,000 monthly blog visitors',
            '4.2% conversion rate to trials',
            '312 backlinks earned'
          ]
        }
      },
      'international-seo':{
        ...
        benefits: [
          ...
          'Geo-specific performance tracking'
        ],
        process: [
          {
            title: 'Market Prioritization',
            description: 'Identify most valuable international markets',
            icon: '🌍'
          },
          {
            title: 'Technical Setup',
            description: 'Implement geo-targeting signals (ccTLDs, hreflang, etc.)',
            icon: '⚙️'
          },
          {
            title: 'Content Localization',
            description: 'Adapt content for cultural and linguistic relevance',
            icon: '🔄'
          },
          {
            title: 'Local Link Building',
            description: 'Acquire region-specific backlinks',
            icon: '🔗'
          },
          {
            title: 'Performance Monitoring',
            description: 'Track metrics by country/language',
            icon: '📉'
          }
        ],
        faqs: [
        ...
        caseStudy: {
          ...
          metrics: [
            ...
            '90% faster international rollout'
          ]
        }
      },
      'seo-analytics':{
        ...
        process: [
          {
            ...
            description: 'Define business objectives and KPIs',
            icon: '🎯'
          },
          {
            title: 'Data Integration',
            description: 'Connect all relevant data sources',
            icon: '🔌'
          },
          {
            title: 'Custom Dashboard Setup',
            description: 'Build tailored reporting views',
            icon: '📊'
          },
          {
            title: 'Insight Development',
            description: 'Analyze trends and opportunities',
            icon: '🔍'
          },
          {
            title: 'Recommendation Engine',
            description: 'Prioritize actions based on data',
            icon: '🚀'
          }
        ],
        faqs: [
      ...
      'local-seo':{
        ...
        process: [
          {
            title: 'Local Audit',
            description: 'Evaluate current local presence and competitors',
            icon: '🔍'
          },
          {
            title: 'GBP Optimization',
            description: 'Complete Google Business Profile setup/enhancement',
            icon: '🏢'
          },
          {
            title: 'Citation Building',
            description: 'Ensure consistent NAP across directories',
            icon: '📇'
          },
          {
          ...
          {
            title: 'Local Content',
            description: 'Create location-specific pages and content',
            icon: '📍'
          }
        ],
        faqs: [
        ...
        caseStudy: {
          title: 'Restaurant Chain Triples Walk-Ins',
          description: 'Local SEO optimizations helped all 14 locations appear in the local 3-pack for key terms.',
          metrics: [
            'Tripled foot traffic',
            '92% increase in calls',
      ...
      'Custom-AI-Agent-Creation' :{
        ...
        process: [
          ...
          },
          {
            ...
            description: 'Determine what searchers want for this query',
            icon: '🧠'
          },
          {
            title: 'Competitor Review',
            description: 'Analyze top-ranking content',
            icon: '🕵️'
          },
          {
            title: 'Structure Planning',
            description: 'Outline optimal content flow',
            icon: '📝'
          },
          {
            title: 'Brief Creation',
            description: 'Compile all elements into clear instructions',
            icon: '📋'
          }
        ],
        faqs: [
        ...
        caseStudy: {
          title: 'Publishing House Cuts Rewrites by 80%',
          description: 'Detailed content briefs standardized their writing process and dramatically improved content quality.',
          metrics: [
            '80% fewer revisions needed',
            'Content ranking time cut in half',
            '45% higher average ranking position'
          ]
        }
      }
  };